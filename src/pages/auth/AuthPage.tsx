      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.modeSwitchContainer}>
            ...
            >
              <Text style={[styles.modeButtonText, isRegister && styles.modeButtonTextActive]}>
                Cadastrar
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <View style={styles.environmentBox}>
            ...
            {apiConfig.isUsingFallback && (
              <Text style={styles.environmentHint}>
                Usando fallback padrão {Platform.OS === 'android' ? '10.0.2.2' : 'localhost'} em modo desenvolvimento.
              </Text>
            )}
          </View>
        </View>
